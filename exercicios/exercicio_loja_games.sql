...
ON tb_produtos.categoria_id = tb_categorias.id WHERE  tb_produtos.categoria_id =3 ;
...
SELECT * FROM tb_produtos INNER JOIN tb_categorias ON tb_produtos.categoria_id = tb_categorias.id
INNER JOIN tb_usuarios ON tb_produtos.usuario_id = tb_usuarios.id WHERE tb_produtos.id= 1;
